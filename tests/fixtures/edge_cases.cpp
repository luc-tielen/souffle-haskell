...
in file /tmp/souffle-haskell/tests/fixtures/edge_cases.dl [20:1-20:27])_");
[&](){
...
in file /tmp/souffle-haskell/tests/fixtures/edge_cases.dl [21:1-21:30])_");
[&](){
CREATE_OP_CONTEXT(rel_1_empty_strings_op_ctxt,rel_1_empty_strings->createContext());
...
();signalHandler->setMsg(R"_(empty_strings("abc","",42).
in file /tmp/souffle-haskell/tests/fixtures/edge_cases.dl [22:1-22:30])_");
[&](){
CREATE_OP_CONTEXT(rel_1_empty_strings_op_ctxt,rel_1_empty_strings->createContext());
...
in file /tmp/souffle-haskell/tests/fixtures/edge_cases.dl [25:1-25:328])_");
[&](){
...
in file /tmp/souffle-haskell/tests/fixtures/edge_cases.dl [33:1-33:27])_");
[&](){
...
in file /tmp/souffle-haskell/tests/fixtures/edge_cases.dl [34:1-34:29])_");
[&](){
CREATE_OP_CONTEXT(rel_3_no_strings_op_ctxt,rel_3_no_strings->createContext());
...
in file /tmp/souffle-haskell/tests/fixtures/edge_cases.dl [30:1-30:16])_");
[&](){
...
();signalHandler->setMsg(R"_(unicode("∀∀").
in file /tmp/souffle-haskell/tests/fixtures/edge_cases.dl [31:1-31:19])_");
[&](){
CREATE_OP_CONTEXT(rel_4_unicode_op_ctxt,rel_4_unicode->createContext());
