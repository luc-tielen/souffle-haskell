...
souffle::RelationWrapper<2,t_btree_i__0__1,Tuple<RamDomain,1>,1,0> wrapper_rel_3_unicode;
public:
Sf_edge_cases() : 
...
wrapper_rel_3_unicode(*rel_3_unicode,symTable,"unicode",std::array<const char *,1>{{"s:symbol"}},std::array<const char *,1>{{"s"}}){
...
in file /home/luc/souffle-haskell/tests/fixtures/edge_cases.dl [17:1-17:27])_");
[&](){
...
in file /home/luc/souffle-haskell/tests/fixtures/edge_cases.dl [18:1-18:30])_");
[&](){
CREATE_OP_CONTEXT(rel_1_empty_strings_op_ctxt,rel_1_empty_strings->createContext());
...
();SignalHandler::instance()->setMsg(R"_(empty_strings("abc","",42).
in file /home/luc/souffle-haskell/tests/fixtures/edge_cases.dl [19:1-19:30])_");
[&](){
CREATE_OP_CONTEXT(rel_1_empty_strings_op_ctxt,rel_1_empty_strings->createContext());
...
in file /home/luc/souffle-haskell/tests/fixtures/edge_cases.dl [22:1-22:328])_");
[&](){
...
in file /home/luc/souffle-haskell/tests/fixtures/edge_cases.dl [27:1-27:16])_");
[&](){
...
();SignalHandler::instance()->setMsg(R"_(unicode("∀∀").
in file /home/luc/souffle-haskell/tests/fixtures/edge_cases.dl [28:1-28:19])_");
[&](){
CREATE_OP_CONTEXT(rel_3_unicode_op_ctxt,rel_3_unicode->createContext());
