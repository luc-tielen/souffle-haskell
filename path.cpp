...
public:
  ...
  std::unique_ptr<t_btree_2__0_1__3> rel_1_edge =
      std::make_unique<t_btree_2__0_1__3>();
  souffle::RelationWrapper<0, t_btree_2__0_1__3, Tuple<RamDomain, 2>, 2>
      wrapper_rel_1_edge;
  // -- Table: reachable
  std::unique_ptr<t_btree_2__0_1__3> rel_2_reachable =
      std::make_unique<t_btree_2__0_1__3>();
  souffle::RelationWrapper<1, t_btree_2__0_1__3, Tuple<RamDomain, 2>, 2>
      wrapper_rel_2_reachable;
  // -- Table: @delta_reachable
  std::unique_ptr<t_btree_2__0_1__1__3> rel_3_delta_reachable =
      std::make_unique<t_btree_2__0_1__1__3>();
  // -- Table: @new_reachable
  std::unique_ptr<t_btree_2__0_1__1__3> rel_4_new_reachable =
      std::make_unique<t_btree_2__0_1__1__3>();

public:
  Sf_path()
      : wrapper_rel_1_edge(
            *rel_1_edge, symTable, "edge",
            std::array<const char *, 2>{{"s:symbol", "s:symbol"}},
            std::array<const char *, 2>{{"n", "m"}}),

        wrapper_rel_2_reachable(
            *rel_2_reachable, symTable, "reachable",
            std::array<const char *, 2>{{"s:symbol", "s:symbol"}},
            std::array<const char *, 2>{{"n", "m"}}) {
...
in file /Users/luc/personal/souffle-c/path.dl [6:1-6:16])_");
      ...
      SignalHandler::instance()->setMsg(R"_(edge("c","b").
in file /Users/luc/personal/souffle-c/path.dl [7:1-7:16])_");
      rel_1_edge->insert(RamDomain(2), RamDomain(1));
      SignalHandler::instance()->setMsg(R"_(edge("c","d").
in file /Users/luc/personal/souffle-c/path.dl [8:1-8:16])_");
   ...
   edge(x,y).
in file /Users/luc/personal/souffle-c/path.dl [10:1-10:31])_");
      if (!(rel_1_edge->empty())) {
        {
          CREATE_OP_CONTEXT(rel_2_reachable_op_ctxt,
                            rel_2_reachable->createContext());
          ...
          for (const auto &env0 : *rel_1_edge) {
            ...
            rel_2_reachable->insert(tuple,
                                    READ_OP_CONTEXT(rel_2_reachable_op_ctxt));
          }
        }
      }
   ...
   edge(x,y),
   reachable(y,z).
in file /Users/luc/personal/souffle-c/path.dl [11:1-11:48])_");
        if (((!(rel_1_edge->empty())) && (!(rel_3_delta_reachable->empty())))) {
          {
            CREATE_OP_CONTEXT(rel_2_reachable_op_ctxt,
                              rel_2_reachable->createContext());
            CREATE_OP_CONTEXT(rel_3_delta_reachable_op_ctxt,
                              rel_3_delta_reachable->createContext());
            CREATE_OP_CONTEXT(rel_1_edge_op_ctxt, rel_1_edge->createContext());
            CREATE_OP_CONTEXT(rel_4_new_reachable_op_ctxt,
                              rel_4_new_reachable->createContext());
            for (const auto &env0 : *rel_1_edge) {
              const Tuple<RamDomain, 2> key({{env0[1], 0}});
              auto range = rel_3_delta_reachable->equalRange_1(
                  key, READ_OP_CONTEXT(rel_3_delta_reachable_op_ctxt));
              for (const auto &env1 : range) {
                if (!(rel_2_reachable->contains(
                        Tuple<RamDomain, 2>({{env0[0], env1[1]}}),
                        READ_OP_CONTEXT(rel_2_reachable_op_ctxt)))) {
                  Tuple<RamDomain, 2> tuple(
                      {{static_cast<RamDomain>(env0[0]),
                        static_cast<RamDomain>(env1[1])}});
                  rel_4_new_reachable->insert(
                      tuple, READ_OP_CONTEXT(rel_4_new_reachable_op_ctxt));
                }
              }
            }
          }
        }
        if (rel_4_new_reachable->empty())
          break;
      ...
      if (performIO) {
        try {
          ...
          IOSystem::getInstance()
              .getWriter(std::vector<bool>({1, 1}), symTable, ioDirectives,
                         false)
              ->writeAll(*rel_2_reachable);
...
SymbolTable *getST_path(SouffleProgram *p) {
  return &reinterpret_cast<Sf_path *>(p)->symTable;
}

#ifdef __EMBEDDED_SOUFFLE__
class factory_Sf_path : public souffle::ProgramFactory {
  SouffleProgram *newInstance() { return new Sf_path(); };

public:
  factory_Sf_path() : ProgramFactory("path") {}
};
#ifdef __EMBEDDED_SOUFFLE_MANUAL_INIT__
static factory_Sf_path *__factory_Sf_path_instance;
extern "C" {
void souffle_init_Sf_path() {
  __factory_Sf_path_instance = new factory_Sf_path();
}
void souffle_destroy_Sf_path() { delete __factory_Sf_path_instance; }
}
#else
static factory_Sf_path __factory_Sf_path_instance;
#endif
...
int main(int argc, char **argv) {
  try {
    souffle::CmdOptions opt(R"(../souffle-c/path.dl)", R"(.)", R"(.)", false,
                            R"()", 1, -1);
